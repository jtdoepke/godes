...
var (
	...
	tableBusy *godes.BooleanControl = godes.NewBooleanControl()
)
...
func Example1() {
	...
	// 455.705	Visitor 12 gets the table
	// 482.955	Visitor 12 leaves
	// 482.955	Visitor 13 gets the table
	// 496.034	Visitor 13 leaves
